...
from server.shock_engine.data_ingestion import fetch_user_data
from server.shock_engine.feature_builder import build_features
from server.shock_engine.monte_carlo import run_simulation, simulate_with_shock
...
def get_llm_insight(db: Session, user_id: int) -> dict[str, Any]:
    ...
    from server.shock_engine.llm_prompts import build_shock_prompt
